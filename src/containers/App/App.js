...
export class App extends Component {
  ...
  evaluateRouteClass = type => {
    ...
    if (this.state.currentDisplay[0] === type)
      futureClass += ' clicked-route-button';
    if (this.state.currentDisplay === type)
      futureClass += ' clicked-route-button';
            ...
            {this.props.id.data && (
              <div>
                <h1 className="user-name">
                  Welcome: {this.props.id.data.name}
                </h1>
                <div className="user-buttons">
                  <NavLink to="/favorites">
                    <button
                      className={`user-fave-button ${this.evaluateRouteClass(
                        'favorites'
                      )}`}
            ...
            <div className="title-buttons">
              ...
              <NavLink to="/popular">
                <button
                  ...
                  onClick={() =>
                    this.setCurrentMovieCategoryGlobalState('popular')
                  }
                >
                  Popular
                </button>
